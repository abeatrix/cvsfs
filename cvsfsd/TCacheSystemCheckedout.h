/***************************************************************************
                          TCacheSystemCheckedout.h  -  description
                             -------------------
...
#ifndef __TCACHESYSTEMCHECKEDOUT_H__
#define __TCACHESYSTEMCHECKEDOUT_H__

#include "TCacheSystem.h"



class TCacheSystemCheckedout : public TCacheSystem
{
  public:
    TCacheSystemCheckedout (const std::string &);
  ...
  private:
    ...
    bool EvaluateFullName (const std::string &, std::string &) const;
};
